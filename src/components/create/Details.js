...
function Details() {
  ...
  const deletegoal = async () => {
    ...
    dispach({ type: "deletegoal", id: form.id });
    browse("/list");
  };
  const cancel = () => {
    browse("/list");
  ...
  return (
    <div className="card">
      ...
      <div className={styles.btns}>
        {!id && (
          <button className="btn btn--black" onClick={create}>
            Create
          </button>
        )}
        {id && (
          <button className="btn btn--black" onClick={update}>
            Update
          </button>
        )}
        {id && (
          <button className="btn btn--red" onClick={deletegoal}>
            Delete
          </button>
        )}
